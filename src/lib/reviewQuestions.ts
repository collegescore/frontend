...
export const reviewQuestions: Question[] = [
  ...
  },
  {
    ...
    type: "text",
    question:
      "Please share 1–3 challenges you’ve experienced related to your identity, especially as a member of one or more underrepresented groups. How did the institution respond to these challenges, if at all?",
    multiline: true,
    placeholder: "Enter your response here...",
  },
  {
