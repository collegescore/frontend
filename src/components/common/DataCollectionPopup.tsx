    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="data-collection-description">
          <Typography variant="body1" component="span" sx={{ color: 'text.primary', mb: 2, display: 'block' }}>
            This project is currently in its <strong>Data Collection Phase</strong>. 
            We rely on reviews from students like you to build a comprehensive database of college experiences.
            Taking 5 minutes to share your experience can help thousands of future students to find the 
            college that will best support their unique identity and accessibility needs.
            Thank you for supporting our mission to pass on your accessibility experiences to future students!
          </Typography>
        </DialogContentText>
      </DialogContent>
